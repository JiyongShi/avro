...
namespace Avro.Test.Generic
{
    class GenericTests
    {
        ...
        public void TestUnion_enum_exception(string unionSchema, string enumSchema, string value)
        {
            Assert.Throws<AvroException>(() => { test(unionSchema, mkEnum(enumSchema, value)); });
        ...
        public void TestUnion_fixed_exception(string unionSchema, string fixedSchema, byte[] value)
        {
            Assert.Throws<AvroException>(() => { test(unionSchema, mkFixed(fixedSchema, value)); });
        }
        ...
        {
            Assert.Throws<AvroException>(() => { testResolutionMismatch(writerSchema, value, readerSchema); });
        }

        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f1\",\"type\":[\"int\", \"null\"]},{\"name\":\"f2\",\"type\":\"int\"}]}",
            new object[] { "f1", 101, "f2", 100 }, "int",
             Description = "Non-record schema")]
        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f1\",\"type\":[\"int\", \"null\"]},{\"name\":\"f2\",\"type\":\"int\"}]}",
            new object[] { "f1", 101, "f2", 100 },
        ...
        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            ...
            "{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f2\",\"type\":\"string\"}]}",
             Description = "incompatible field")]
        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f1\",\"type\":[\"int\", \"null\"]},{\"name\":\"f2\",\"type\":\"int\"}]}",
            new object[] { "f1", 101, "f2", 100 },
            "{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f3\",\"type\":\"string\"}]}",
             Description = "new field without default")]
        public void TestResolutionMismatch_record(string ws, object[] actual, string rs)
        {
            Assert.Throws<AvroException>(() => { testResolutionMismatch(ws, mkRecord(actual, Schema.Parse(ws) as RecordSchema), rs); });
        }
        ...
        {
            Assert.Throws<AvroException>(() => { testResolutionMismatch(ws, mkEnum(ws, value), rs); });
        }
        ...
        {
            Assert.Throws<AvroException>(() => { testResolutionMismatch(ws, mkMap(value), rs); });
        }
        ...
        {
            Assert.Throws<AvroException>(() => { testResolutionMismatch(ws, mkFixed(ws, value), rs); });
        }
